...
void describe('dist/main.tailwind.css integration test', () => {
  let content: string;

  before(() => {
    const filePath = path.join(distDir, 'main.tailwind.css');
  ...
  void describe('Tailwind v4 structure', () => {
    void it('should have tailwindcss import', () => {
      assert.ok(content.includes("@import 'tailwindcss'"));
    });

    void it('should have @theme block', () => {
      assert.ok(content.includes('@theme {'));
    });

    void it('should have dark mode media query inside @theme', () => {
  ...
  void describe('semantic tokens', () => {
    void it('should have semantic tokens comment', () => {
      assert.ok(content.includes('/* Semantic Tokens */'));
    });
